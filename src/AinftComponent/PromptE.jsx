...
function PromptE() {
  return (
    <div className="max-w-[1320px] w-full  mx-auto py-10">
      ...
      <div className="max-w-[1320px] w-full mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-10">
        {promptData.map((prompt, index) => (
          ...
          >
            <div className="w-full lg:max-w-[310px] h-[232px] relative">
              ...
              <button className="w-[58px] h-[58px] rounded-full absolute left-1/2 -bottom-6 lg:top-1/2 lg:left-[100%]  bg-red-500 text-white transform -translate-x-1/2 lg:-translate-y-1/2 flex justify-center items-center border-3 border-[#FFF9F9]">
                <span className="text-white font-[Roboto] text-[12px] font-normal leading-normal tracking-[0.36px] opacity-75">
                  Copy
                </span>
                <img src={copy} alt="" className="w-[13px] h-[13px] ml-1" />
              </button>
            </div>
