...
function Form({
  showAfterChoose = true,
  btn = "Mint NFT",
  showButn = false,
  topbtn = "Single NFT",
  formtitle = "Mint Your NFT",
  showselected = true,
  firstname = "Item Name*",
  firstinput = "Name your NFT"
}) {
      ...
      <div className="flex gap-6 flex-col lg:flex-row">
        <div>
          ...
          >
            ...
            {showselected && (
              <p
                className="text-white font-apex text-[20px] font-normal leading-normal tracking-[0.8px] capitaliz 
...
text-[#2B2B2B] text-center font-apex text-[40px] font-normal leading-normal tracking-[1.6px] capitalize"
          ...
          <div>
            ...
            <div className="relative">
              {/* 🔹 Styled Dollar Sign */}
              <span
                className="absolute left-4 top-1/2 transform -translate-y-1/2 text-[#2B2B2B] font-roboto text-[18px] font-normal tracking-[0.54px]
"
              >
                $
              </span>
 ...
 h-[158px] max-w-[817px] w-full"
            ...
            <>
              ...
              <div>
                ...
                <div className="bg-white px-[30px] py-[18px] w-[195px] h-[58px] rounded-[15px] flex gap-3 border-[2.8px] border-solid border-[#E7E7E7] justify-center items-center">
                  <button
                    className="text-[#808080] font-roboto text-[18px] font-normal tracking-[0.54px] "
          ...
          <div className="flex justify-end">
            <button
              className="px-8 py-4 rounded-[8px] flex items-center bg-gradient-custom text-white text-center font-roboto text-[18px] font-medium capitalize hover:opacity-90 w-[139px] h-[53px]"
              onClick={handleMint}
            >
              {btn}
            </button>
