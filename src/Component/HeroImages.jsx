...
function HeroImages() {
  ...
  return (
    ...
    className="bg-contain bg-center bg-no-repeat md:h-[630px] h-[450px] max-w-[1920px] w-full bg-gradient-to-b from-white to-pink-50">
        <div className='max-w-[1120px] w-full mx-auto h-auto '>
          <div className="card relative  ">
               ...
               <img src={herosr} alt="" className='w-[208px] h-[350px]   absolute top-[50px] right-[160px] z-10 s-left hidden lg:block' />
          </div>
        </div>
