    ...
    <div className=" py-8 px-4 sm:px-8 md:px-16 lg:my-10">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center">
        ...
        <div className="lg:w-1/2 text-center lg:text-left">
          ...
          <button className="mt-6 flex gap-2 items-center justify-center text-[22px] w-[217px] h-[58px] cursor-pointer bg-gradient-to-r from-[#FD0000] to-[#fd2121] text-white py-3 px-8 rounded-lg shadow-lg hover:bg-red-600 focus:ring focus:ring-red-300 xs:mx-auto">
